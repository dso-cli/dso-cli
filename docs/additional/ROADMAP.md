...
- ✅ Updated vulnerable dependency `lodash@4.17.20` → `4.17.21`
...
```json
{
  "text": "🚨 New Security Issues Detected",
  "blocks": [
    {
      "type": "section",
      "text": {
...
```json
{
  ...
  "sections": [{
    "activityTitle": "🚨 New Security Issues",
    "facts": [
...
func EstimateCost(provider string, tokenCount int) {
    ...
    case "gemini":
        ...
        fmt.Printf("⚠️  Estimated cost: $%.2f\n", cost)
    case "claude":
